  ...
  const completeOrderClick = async () => {
    try {
      ...
      const { data } = await axios.post(
        "https://612a4354068adf001789baa2.mockapi.io/orders",
        { items: cartItems }
      );
      setOrderId(data.id);
      ...
      for (let i = 0; i < cartItems.length; i++) {
        ...
        await axios.delete(
          "https://612a4354068adf001789baa2.mockapi.io/cart/" + item.id
        );
        await delay(1000);
      }
    } catch (error) {
      ...
      <div className={styles.drawer}>
        ...
        {items.length > 0 ? (
          ...
          <Info
            ...
            image={
              orderIsComplete ? "img/complete-order.jpg" : "img/cart-empty.png"
            }
          />
        )}
      </div>
